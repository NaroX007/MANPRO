        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <!-- Form Edit -->
                    <form action="{{ route('artikel.update', $artikel->id) }}" enctype="multipart/form-data" method="POST" class="space-y-6">
                        @csrf
                        @method('PUT')
                        ...
                        <div>
                            ...
                            <input type="hidden" id="deskripsi" name="deskripsi" value="{{ old('deskripsi', $artikel->deskripsi) }}" />
                        ...
                        <div class="flex justify-end gap-2">
                            <a href="{{ route('artikel.index') }}" class="m-4 bg-gray-500 px-4 py-2 text-white hover:text-gray-800 rounded-md">
                                {{ __('Cancel') }}
                            </a>
                            <button type="submit"
