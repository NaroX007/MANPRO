 ...
 <body class="bg-blue-900 text-white">
  <div class="flex flex-col md:flex-row h-screen">
   <div class="md:w-1/2 flex flex-col justify-up items-start p-10">
    <img alt="SumbarCamp logo" class="mb-4" height="100" src="<?php echo e(asset('img/image1.png')); ?>" width="100"/>
   ...
   <div class="md:w-1/2 relative">
    <img alt="Camping scene with a tent and a waterfall in the background" class="w-full h-full object-cover" height="600" src="<?php echo e(asset('img/image4.png')); ?>" width="800"/>
...
<?php /**PATH C:\xampp\htdocs\camping\resources\views/index.blade.php ENDPATH**/ ?>