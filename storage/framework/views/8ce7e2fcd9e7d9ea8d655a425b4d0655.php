      ...
      <div class="flex justify-center items-center sm:items-stretch sm:justify-start">
        ...
        <div class="flex flex-row">
          ...
          <div class="hidden sm:ml-6 sm:block lg:flex justify-between items-center ">
            <div class="flex space-x-4">
              <!-- Dropdown -->
              <form class="flex" action="<?php echo e(route('campground')); ?>" method="GET">
                <div class="relative group">
                  ...
                  <div class="absolute left-0 mt-2 w-48 bg-white rounded-md shadow-lg opacity-0 scale-95 transition-opacity duration-300 ease-in-out group-hover:opacity-100 group-hover:scale-100">
                    <?php echo csrf_field(); ?>
                    ...
                    <a href="<?php echo e(route ('artikel')); ?>" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Artikel</a>
                    <a href="<?php echo e(route ('tip')); ?>" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Tips</a>
                  </div>
                </div>
              </form>
            </div>
...
</nav><?php /**PATH D:\rpl_final\camping\resources\views/ui/navbar.blade.php ENDPATH**/ ?>