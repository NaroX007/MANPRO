...
<?php $__currentLoopData = $tip; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="p-4 flex flex-col md:flex-row border-b">
     <img alt="Beginner camping tips" class="w-full md:w-1/4 h-auto rounded-md" height="150" src="<?php echo e(asset('storage/' . $item->image)); ?>" width="150"/>
     <div class="md:ml-4 mt-4 md:mt-0">
      <h2 class="text-xl font-bold text-blue-900">
      <?php echo e($item->nama); ?>

      </h2>
      <?php echo Str::limit(strip_tags($item->deskripsi), 20); ?>

</br>
</br>
      <butt class="bg-orange-400 text-white px-4 py-2 rounded-md mt-4">

      <a href="<?php echo e(route ('detailtip' , $item->id)); ?>">Selengkapnya</a>
      </button>
     </div>
    </div>
...
<?php /**PATH D:\rpl_final\camping\resources\views/tips.blade.php ENDPATH**/ ?>