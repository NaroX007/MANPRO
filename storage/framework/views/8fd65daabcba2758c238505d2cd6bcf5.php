        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <h1 class="text-2xl font-bold mb-6">Tip List</h1>

                    <div class="mb-4">
                        <a href="<?php echo e(route('tip.create')); ?>" 
                    ...
                    <div id="non-form">
                        ...
                        <table class="table-auto w-full border-collapse border border-gray-300 dark:border-gray-700">
                                ...
                                <tbody>
                                    <?php $__empty_1 = true; $__currentLoopData = $tip; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $new): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr class="border-t border-gray-300 dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-gray-800">
                                            ...
                                            <td class="flex justify-center gap-4 border border-gray dark:border-gray-700 text-left text-sm font-medium px-4 py-2 text-sm">
                                                <a href="<?php echo e(route('tip.edit', $new->id)); ?>" class="rounded-md bg bg-gray-500 px-4 py-2 text-white hover:underline">Edit</a>
                                                <form action="<?php echo e(route('tip.destroy', $new->id)); ?>" method="POST" class="inline">
                                                    <?php echo csrf_field(); ?>
...
<?php endif; ?><?php /**PATH D:\rpl_final\camping\resources\views/dashboard/tip/index.blade.php ENDPATH**/ ?>