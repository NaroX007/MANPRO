<html lang="en">
 ...
 <body class="bg-gray-100">
  ...
  <div class="max-w-4xl mx-auto bg-white rounded-lg shadow-lg overflow-hidden">
   <div class="relative">
    <img alt="Sunset view at Pantai Air Manis" class="w-full h-64 object-cover" height="300" src="<?php echo e(asset('storage/' . $artikel->image)); ?>" width="800"/>
...
<?php /**PATH D:\rpl_final\camping\resources\views/detailartikel.blade.php ENDPATH**/ ?>