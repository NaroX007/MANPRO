...
<?php echo $__env->make('ui.navbar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
  ...
  <div class="bg-blue-900 py-4">
   <div class="container mx-auto px-4 flex items-center justify-between">
    <form action="<?php echo e(url()->current()); ?>" method="GET" class="flex items-center bg-white rounded-md overflow-hidden">
...
<?php /**PATH C:\xampp\htdocs\camping\resources\views/campground.blade.php ENDPATH**/ ?>